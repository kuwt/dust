...
\end{inputfile}
\begin{itemize} 
  \item \param{cx}, \param{cy} and \param{cz} represents the position of the centers of each element.
  \item \param{nx}, \param{ny} and \param{nz} represents the position of the centers of each element.
  \item \param{area} represents the area of each element
  \item \param{rho} represents the density of each element
  \item \param{pressure} represents the total pressure of each element
  \item \param{rhoux}, \param{rhouy} and \param{rhouz} represents the product between the velocity and the density 
  \item \param{svx}, \param{svy} and \param{svz} represents the velocity of the centers of each element.
\end{itemize}
